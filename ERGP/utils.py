r"""
    ...
    Date: 2022/06/27
    Description: Utility functions for model training.
"""
...
class RecTrainer(object):
    r"""
    Trainer class.
    Source: https://github.com/RUCAIBox/RecBole/blob/master/recbole/utils/utils.py#L193-L217
    """
    def __init__(self, dataset='Pinterest'):
        self.model_name = ERGP
...
def init_logger(config):
    ...
    Source: https://github.com/RUCAIBox/RecBole/blob/master/recbole/utils/logger.py#L56-L110
    """
    init(autoreset=True)
    LOGROOT = './Log/'
